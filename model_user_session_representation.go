...
// GetTransientUser returns the TransientUser field value if set, zero value otherwise.
func (o *UserSessionRepresentation) GetTransientUser() bool {
	if o == nil || IsNil(o.TransientUser) {
		var ret bool
		return ret
	}
	return *o.TransientUser
}

// GetTransientUserOk returns a tuple with the TransientUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSessionRepresentation) GetTransientUserOk() (*bool, bool) {
	if o == nil || IsNil(o.TransientUser) {
		return nil, false
	}
	return o.TransientUser, true
}
...
// SetTransientUser gets a reference to the given bool and assigns it to the TransientUser field.
...
func (o UserSessionRepresentation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TransientUser) {
		toSerialize["transientUser"] = o.TransientUser
	}
