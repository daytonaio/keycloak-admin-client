...
func Test_keycloak_admin_client_RolesAPIService(t *testing.T) {
	...
	t.Run("Test RolesAPIService AdminRealmsRealmClientsClientUuidRolesRoleNameCompositesClientsClientInCompositeUuidGet", func(t *testing.T) {
		...
		var clientUuid string
		var roleName string
		var clientInCompositeUuid string

		resp, httpRes, err := apiClient.RolesAPI.AdminRealmsRealmClientsClientUuidRolesRoleNameCompositesClientsClientInCompositeUuidGet(context.Background(), realm, clientUuid, roleName, clientInCompositeUuid).Execute()
