...
// GetGlobalPolicies returns the GlobalPolicies field value if set, zero value otherwise.
func (o *ClientPoliciesRepresentation) GetGlobalPolicies() []ClientPolicyRepresentation {
	if o == nil || IsNil(o.GlobalPolicies) {
		var ret []ClientPolicyRepresentation
		return ret
	}
	return o.GlobalPolicies
}

// GetGlobalPoliciesOk returns a tuple with the GlobalPolicies field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClientPoliciesRepresentation) GetGlobalPoliciesOk() ([]ClientPolicyRepresentation, bool) {
	if o == nil || IsNil(o.GlobalPolicies) {
		return nil, false
	}
	return o.GlobalPolicies, true
}
...
// SetGlobalPolicies gets a reference to the given []ClientPolicyRepresentation and assigns it to the GlobalPolicies field.
...
func (o ClientPoliciesRepresentation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GlobalPolicies) {
		toSerialize["globalPolicies"] = o.GlobalPolicies
	}
