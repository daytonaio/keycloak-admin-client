...
// GetUnmanagedAttributePolicy returns the UnmanagedAttributePolicy field value if set, zero value otherwise.
func (o *UPConfig) GetUnmanagedAttributePolicy() UnmanagedAttributePolicy {
	if o == nil || IsNil(o.UnmanagedAttributePolicy) {
		var ret UnmanagedAttributePolicy
		return ret
	}
	return *o.UnmanagedAttributePolicy
}

// GetUnmanagedAttributePolicyOk returns a tuple with the UnmanagedAttributePolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UPConfig) GetUnmanagedAttributePolicyOk() (*UnmanagedAttributePolicy, bool) {
	if o == nil || IsNil(o.UnmanagedAttributePolicy) {
		return nil, false
	}
	return o.UnmanagedAttributePolicy, true
}
...
// SetUnmanagedAttributePolicy gets a reference to the given UnmanagedAttributePolicy and assigns it to the UnmanagedAttributePolicy field.
func (o *UPConfig) SetUnmanagedAttributePolicy(v UnmanagedAttributePolicy) {
	o.UnmanagedAttributePolicy = &v
}
...
func (o UPConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UnmanagedAttributePolicy) {
		toSerialize["unmanagedAttributePolicy"] = o.UnmanagedAttributePolicy
	}
